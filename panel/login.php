  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="" method="post">
        <h2 class="form-login-heading">Şimdi Giriş Yap</h2>
        <div class="login-wrap">
          ...
          <hr>
          <button class="btn btn-theme form-control btn-block mt-2" name="login" type="submit"><i class="fa fa-lock"></i> Giriş Yap</button>
          <hr>
        </div>
      </form>
    </div>
